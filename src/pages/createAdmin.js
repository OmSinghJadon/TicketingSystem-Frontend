...
const CreateAdmin = () => {
    ...
    return (
      <>
          <div className='rounded-3 p-3' style={{backgroundColor:"rgb(234,243,252)", minHeight:"84vh", minWidth:"100%"}}>
        ...
        <form onSubmit={handleSubmit} encType='multipart/form-data'>
          ...
          <div className="form-group w-75 d-flex flex-column ">
          ...
          <label htmlFor="group">Group</label>
                <select
                  ...
                  className="group form-select w-75 my-2"
                  onChange={(e) => {
